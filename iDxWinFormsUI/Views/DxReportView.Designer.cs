namespace iDxWinFormsUI.Views
{
	partial class DxReportView
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DxReportView));
			...
			this.xrDesignBarManager1.BarInfos.AddRange(new DevExpress.XtraReports.UserDesigner.BarInfo[] { barInfo1 });
			this.xrDesignBarManager1.Bars.AddRange(new DevExpress.XtraBars.Bar[] { this.designBar1, this.designBar2, this.designBar3, this.designBar4, this.designBar5, this.bar1, this.bar2 });
			...
			this.xrDesignBarManager1.Items.AddRange(new DevExpress.XtraBars.BarItem[] { this.beiFontName, this.beiFontSize, this.bbiFontBold, this.bbiFontItalic, this.bbiFontUnderline, this.bbiForeColor, this.bbiBackColor, this.bbiJustifyLeft, this.bbiJustifyCenter, this.bbiJustifyRight, this.bbiJustifyJustify, this.bbiAlignToGrid, this.bbiAlignLeft, this.bbiAlignVerticalCenters, this.bbiAlignRight, this.bbiAlignTop, this.bbiAlignHorizontalCenters, this.bbiAlignBottom, this.bbiSizeToControlWidth, this.bbiSizeToGrid, this.bbiSizeToControlHeight, this.bbiSizeToControl, this.bbiHorizSpaceMakeEqual, this.bbiHorizSpaceIncrease, this.bbiHorizSpaceDecrease, this.bbiHorizSpaceConcatenate, this.bbiVertSpaceMakeEqual, this.bbiVertSpaceIncrease, this.bbiVertSpaceDecrease, this.bbiVertSpaceConcatenate, this.bbiCenterHorizontally, this.bbiCenterVertically, this.bbiBringToFront, this.bbiSendToBack, this.commandBarItem1, this.bbiOpenFile, this.bbiSaveFile, this.bbiCut, this.bbiCopy, this.bbiPaste, this.bbiUndo, this.bbiRedo, this.bsiHint, this.msiFile, this.msiEdit, this.msiTabButtons, this.barReportTabButtonsListItem1, this.barSubItem1, this.xrBarToolbarsListItem1, this.barSubItem2, this.barDockPanelsListItem1, this.msiFormat, this.msiFont, this.msiJustify, this.msiAlign, this.msiSameSize, this.msiHorizontalSpacing, this.msiVerticalSpacing, this.bsiCenter, this.msiOrder, this.commandBarItem2, this.commandBarItem3, this.commandBarItem4, this.commandBarItem5, this.commandBarItem6, this.commandBarItem7, this.msiWindow, this.msiWindowInterface, this.commandBarItem8, this.commandBarItem9, this.commandBarItem10, this.msiWindows, this.commandBarItem11, this.bbiZoomOut, this.bbiZoom, this.bbiZoomIn });
			...
			this.xrDesignBarManager1.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] { this.recentlyUsedItemsComboBox1, this.designRepositoryItemComboBox1, this.designRepositoryItemComboBox2 });
			...
			this.xrDesignBarManager1.Updates.AddRange(new string[] { "Toolbox" });
			...
			this.designBar1.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.msiFile), new DevExpress.XtraBars.LinkPersistInfo(this.msiEdit), new DevExpress.XtraBars.LinkPersistInfo(this.msiTabButtons), new DevExpress.XtraBars.LinkPersistInfo(this.msiFormat), new DevExpress.XtraBars.LinkPersistInfo(this.msiWindow) });
			...
			this.msiFile.Id = 43;
			this.msiFile.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem1), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem2), new DevExpress.XtraBars.LinkPersistInfo(this.bbiOpenFile), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSaveFile, true), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem3), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem7), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem11), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem4, true) });
			...
			this.commandBarItem1.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.N);
			...
			this.commandBarItem2.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.W);
			...
			this.bbiOpenFile.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.O);
			...
			this.bbiSaveFile.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.S);
			...
			this.commandBarItem7.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.L);
			...
			this.commandBarItem11.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.F4);
			...
			this.msiEdit.Id = 44;
			this.msiEdit.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiUndo, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiRedo), new DevExpress.XtraBars.LinkPersistInfo(this.bbiCut, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiCopy), new DevExpress.XtraBars.LinkPersistInfo(this.bbiPaste), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem5), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem6, true) });
			...
			this.bbiUndo.Id = 40;
			this.bbiUndo.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.Z);
			...
			this.bbiRedo.Id = 41;
			this.bbiRedo.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.Y);
			...
			this.bbiCut.Id = 37;
			this.bbiCut.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.X);
			...
			this.bbiCopy.Id = 38;
			this.bbiCopy.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.C);
			...
			this.bbiPaste.Id = 39;
			this.bbiPaste.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.V);
			...
			this.commandBarItem6.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.A);
			...
			this.msiTabButtons.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.barReportTabButtonsListItem1), new DevExpress.XtraBars.LinkPersistInfo(this.barSubItem1, true), new DevExpress.XtraBars.LinkPersistInfo(this.barSubItem2, true) });
			...
			this.barSubItem1.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.xrBarToolbarsListItem1) });
			...
			this.barSubItem2.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.barDockPanelsListItem1) });
			...
			this.msiFormat.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiForeColor), new DevExpress.XtraBars.LinkPersistInfo(this.bbiBackColor), new DevExpress.XtraBars.LinkPersistInfo(this.msiFont, true), new DevExpress.XtraBars.LinkPersistInfo(this.msiJustify), new DevExpress.XtraBars.LinkPersistInfo(this.msiAlign, true), new DevExpress.XtraBars.LinkPersistInfo(this.msiSameSize), new DevExpress.XtraBars.LinkPersistInfo(this.msiHorizontalSpacing, true), new DevExpress.XtraBars.LinkPersistInfo(this.msiVerticalSpacing), new DevExpress.XtraBars.LinkPersistInfo(this.bsiCenter, true), new DevExpress.XtraBars.LinkPersistInfo(this.msiOrder, true) });
			...
			this.msiFont.Id = 52;
			this.msiFont.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiFontBold, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiFontItalic), new DevExpress.XtraBars.LinkPersistInfo(this.bbiFontUnderline) });
			...
			this.bbiFontBold.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.B);
			...
			this.bbiFontItalic.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.I);
			...
			this.bbiFontUnderline.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.U);
			...
			this.msiJustify.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiJustifyLeft, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiJustifyCenter), new DevExpress.XtraBars.LinkPersistInfo(this.bbiJustifyRight), new DevExpress.XtraBars.LinkPersistInfo(this.bbiJustifyJustify) });
			...
			this.msiAlign.Id = 54;
			this.msiAlign.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignLeft, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignVerticalCenters), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignRight), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignTop, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignHorizontalCenters), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignBottom), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignToGrid, true) });
			...
			this.msiSameSize.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiSizeToControlWidth, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSizeToGrid), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSizeToControlHeight), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSizeToControl) });
			...
			this.msiHorizontalSpacing.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiHorizSpaceMakeEqual, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiHorizSpaceIncrease), new DevExpress.XtraBars.LinkPersistInfo(this.bbiHorizSpaceDecrease), new DevExpress.XtraBars.LinkPersistInfo(this.bbiHorizSpaceConcatenate) });
			...
			this.msiVerticalSpacing.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiVertSpaceMakeEqual, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiVertSpaceIncrease), new DevExpress.XtraBars.LinkPersistInfo(this.bbiVertSpaceDecrease), new DevExpress.XtraBars.LinkPersistInfo(this.bbiVertSpaceConcatenate) });
			...
			this.bsiCenter.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiCenterHorizontally, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiCenterVertically) });
			...
			this.msiOrder.Id = 59;
			this.msiOrder.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiBringToFront, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSendToBack) });
			...
			this.msiWindow.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.msiWindowInterface, true), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem8), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem9), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem10), new DevExpress.XtraBars.LinkPersistInfo(this.msiWindows, true) });
			...
			this.designBar2.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem1), new DevExpress.XtraBars.LinkPersistInfo(this.bbiOpenFile), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSaveFile), new DevExpress.XtraBars.LinkPersistInfo(this.commandBarItem7), new DevExpress.XtraBars.LinkPersistInfo(this.bbiCut, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiCopy), new DevExpress.XtraBars.LinkPersistInfo(this.bbiPaste), new DevExpress.XtraBars.LinkPersistInfo(this.bbiUndo, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiRedo) });
			...
			this.designBar3.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.beiFontName), new DevExpress.XtraBars.LinkPersistInfo(this.beiFontSize), new DevExpress.XtraBars.LinkPersistInfo(this.bbiFontBold), new DevExpress.XtraBars.LinkPersistInfo(this.bbiFontItalic), new DevExpress.XtraBars.LinkPersistInfo(this.bbiFontUnderline), new DevExpress.XtraBars.LinkPersistInfo(this.bbiForeColor, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiBackColor), new DevExpress.XtraBars.LinkPersistInfo(this.bbiJustifyLeft, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiJustifyCenter), new DevExpress.XtraBars.LinkPersistInfo(this.bbiJustifyRight), new DevExpress.XtraBars.LinkPersistInfo(this.bbiJustifyJustify) });
			...
			// 
			this.recentlyUsedItemsComboBox1.AppearanceDropDown.Font = new Font("Tahoma", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
			this.recentlyUsedItemsComboBox1.AppearanceDropDown.Options.UseFont = true;
			this.recentlyUsedItemsComboBox1.AutoHeight = false;
			this.recentlyUsedItemsComboBox1.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] { new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo) });
			...
			this.designRepositoryItemComboBox1.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] { new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo) });
			...
			this.designBar4.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignToGrid), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignLeft, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignVerticalCenters), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignRight), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignTop, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignHorizontalCenters), new DevExpress.XtraBars.LinkPersistInfo(this.bbiAlignBottom), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSizeToControlWidth, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSizeToGrid), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSizeToControlHeight), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSizeToControl), new DevExpress.XtraBars.LinkPersistInfo(this.bbiHorizSpaceMakeEqual, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiHorizSpaceIncrease), new DevExpress.XtraBars.LinkPersistInfo(this.bbiHorizSpaceDecrease), new DevExpress.XtraBars.LinkPersistInfo(this.bbiHorizSpaceConcatenate), new DevExpress.XtraBars.LinkPersistInfo(this.bbiVertSpaceMakeEqual, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiVertSpaceIncrease), new DevExpress.XtraBars.LinkPersistInfo(this.bbiVertSpaceDecrease), new DevExpress.XtraBars.LinkPersistInfo(this.bbiVertSpaceConcatenate), new DevExpress.XtraBars.LinkPersistInfo(this.bbiCenterHorizontally, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiCenterVertically), new DevExpress.XtraBars.LinkPersistInfo(this.bbiBringToFront, true), new DevExpress.XtraBars.LinkPersistInfo(this.bbiSendToBack) });
			...
			this.designBar5.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bsiHint) });
			...
			this.bar1.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] { new DevExpress.XtraBars.LinkPersistInfo(this.bbiZoomOut), new DevExpress.XtraBars.LinkPersistInfo(this.bbiZoom), new DevExpress.XtraBars.LinkPersistInfo(this.bbiZoomIn) });
			...
			this.bbiZoomOut.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.Subtract);
			...
			this.designRepositoryItemComboBox2.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] { new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo) });
			...
			this.bbiZoomIn.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.Add);
			...
			this.barDockControlTop.Size = new Size(1280, 72);
			// 
			// barDockControlBottom
			// 
			this.barDockControlBottom.CausesValidation = false;
			this.barDockControlBottom.Dock = DockStyle.Bottom;
			this.barDockControlBottom.Location = new Point(0, 777);
			this.barDockControlBottom.Manager = this.xrDesignBarManager1;
			this.barDockControlBottom.Size = new Size(1280, 23);
			// 
			// barDockControlLeft
			// 
			this.barDockControlLeft.CausesValidation = false;
			this.barDockControlLeft.Dock = DockStyle.Left;
			this.barDockControlLeft.Location = new Point(0, 72);
			this.barDockControlLeft.Manager = this.xrDesignBarManager1;
			this.barDockControlLeft.Size = new Size(21, 705);
			// 
			// barDockControlRight
			// 
			this.barDockControlRight.CausesValidation = false;
			this.barDockControlRight.Dock = DockStyle.Right;
			this.barDockControlRight.Location = new Point(1280, 72);
			this.barDockControlRight.Manager = this.xrDesignBarManager1;
			this.barDockControlRight.Size = new Size(0, 705);
			// 
			...
			this.xrDesignDockManager1.RootPanels.AddRange(new DevExpress.XtraBars.Docking.DockPanel[] { this.panelContainer1, this.panelContainer4 });
			this.xrDesignDockManager1.TopZIndexControls.AddRange(new string[] { "DevExpress.XtraBars.BarDockControl", "DevExpress.XtraBars.StandaloneBarDockControl", "System.Windows.Forms.MenuStrip", "System.Windows.Forms.StatusStrip", "System.Windows.Forms.StatusBar", "DevExpress.XtraBars.Ribbon.RibbonStatusBar", "DevExpress.XtraBars.Ribbon.RibbonControl", "DevExpress.XtraBars.Navigation.OfficeNavigationBar", "DevExpress.XtraBars.Navigation.TileNavPane", "DevExpress.XtraBars.TabFormControl", "DevExpress.XtraBars.FluentDesignSystem.FluentDesignFormControl", "DevExpress.XtraBars.ToolbarForm.ToolbarFormControl", "DevExpress.XtraReports.UserDesigner.XRToolBoxPanel" });
			// 
			// panelContainer1
			// 
			...
			this.panelContainer1.ID = new Guid("6ee648c9-4a57-463b-b88c-3df649f2138c");
			this.panelContainer1.Location = new Point(910, 72);
			this.panelContainer1.Name = "panelContainer1";
			this.panelContainer1.OriginalSize = new Size(370, 200);
			this.panelContainer1.Size = new Size(370, 705);
			...
			this.panelContainer2.ID = new Guid("8a28ede6-21b4-49b2-bbca-f5ee9ca042e8");
			this.panelContainer2.Location = new Point(0, 0);
			this.panelContainer2.Name = "panelContainer2";
			this.panelContainer2.OriginalSize = new Size(370, 253);
			this.panelContainer2.Size = new Size(370, 353);
			...
			this.reportExplorerDockPanel1.Location = new Point(1, 23);
			this.reportExplorerDockPanel1.Name = "reportExplorerDockPanel1";
			this.reportExplorerDockPanel1.OriginalSize = new Size(369, 203);
			this.reportExplorerDockPanel1.Size = new Size(369, 303);
			...
			this.reportExplorerDockPanel1_Container.Size = new Size(369, 303);
			...
			this.fieldListDockPanel1.Location = new Point(1, 23);
			this.fieldListDockPanel1.Name = "fieldListDockPanel1";
			this.fieldListDockPanel1.OriginalSize = new Size(369, 203);
			this.fieldListDockPanel1.Size = new Size(369, 303);
			...
			this.fieldListDockPanel1_Container.Size = new Size(369, 303);
			...
			this.panelContainer3.ID = new Guid("53ab5d79-ecf1-4527-8ce0-ae0a5df011da");
			this.panelContainer3.Location = new Point(0, 353);
			this.panelContainer3.Name = "panelContainer3";
			this.panelContainer3.OriginalSize = new Size(370, 252);
			this.panelContainer3.Size = new Size(370, 352);
			...
			this.propertyGridDockPanel1.Location = new Point(1, 24);
			this.propertyGridDockPanel1.Name = "propertyGridDockPanel1";
			this.propertyGridDockPanel1.OriginalSize = new Size(369, 201);
			this.propertyGridDockPanel1.Size = new Size(369, 301);
			...
			this.propertyGridDockPanel1_Container.Size = new Size(369, 301);
			...
			this.reportGalleryDockPanel1.ID = new Guid("7cd5b1e8-63bb-46f7-af65-af61eb851a38");
			this.reportGalleryDockPanel1.Location = new Point(1, 24);
			this.reportGalleryDockPanel1.Name = "reportGalleryDockPanel1";
			this.reportGalleryDockPanel1.OriginalSize = new Size(369, 201);
			this.reportGalleryDockPanel1.Size = new Size(369, 301);
			this.reportGalleryDockPanel1.Text = "Report Gallery";
			// 
			// reportGalleryDockPanel1_Container
			// 
			this.reportGalleryDockPanel1_Container.Location = new Point(0, 0);
			this.reportGalleryDockPanel1_Container.Name = "reportGalleryDockPanel1_Container";
			this.reportGalleryDockPanel1_Container.Size = new Size(369, 301);
			...
			this.panelContainer4.ID = new Guid("589c46d5-d554-487c-885d-2e040b520c1c");
			this.panelContainer4.Location = new Point(21, 577);
			this.panelContainer4.Name = "panelContainer4";
			this.panelContainer4.OriginalSize = new Size(200, 200);
			this.panelContainer4.Size = new Size(889, 200);
			...
			this.groupAndSortDockPanel1.Location = new Point(0, 24);
			this.groupAndSortDockPanel1.Name = "groupAndSortDockPanel1";
			this.groupAndSortDockPanel1.OriginalSize = new Size(409, 149);
			this.groupAndSortDockPanel1.Size = new Size(889, 149);
			...
			this.groupAndSortDockPanel1_Container.Size = new Size(889, 149);
			...
			this.errorListDockPanel1.Location = new Point(0, 24);
			this.errorListDockPanel1.Name = "errorListDockPanel1";
			this.errorListDockPanel1.OriginalSize = new Size(409, 149);
			this.errorListDockPanel1.Size = new Size(889, 149);
			...
			this.errorListDockPanel1_Container.Size = new Size(889, 149);
			...
			this.reportDesigner1.DesignPanelListeners.AddRange(new DevExpress.XtraReports.UserDesigner.XRDesignPanelListener[] { xrDesignPanelListener1, xrDesignPanelListener2, xrDesignPanelListener3, xrDesignPanelListener4, xrDesignPanelListener5, xrDesignPanelListener6, xrDesignPanelListener7, xrDesignPanelListener8 });
			this.reportDesigner1.Form = null;
			// 
			// DxReportView
			// 
			this.Appearance.Font = new Font("Microsoft JhengHei", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
