namespace iDxWinFormsUI.Views
{
	partial class DxPdfView
	{
		...
		private void InitializeComponent()
		{
			...
			this.pdfFileOpenBarItem1.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.O);
			this.pdfFileOpenBarItem1.Name = "pdfFileOpenBarItem1";
			// 
			// pdfFileSaveAsBarItem1
			// 
			this.pdfFileSaveAsBarItem1.Id = 2;
			this.pdfFileSaveAsBarItem1.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.S);
			this.pdfFileSaveAsBarItem1.Name = "pdfFileSaveAsBarItem1";
			// 
			// pdfFilePrintBarItem1
			// 
			this.pdfFilePrintBarItem1.Id = 3;
			this.pdfFilePrintBarItem1.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.P);
			this.pdfFilePrintBarItem1.Name = "pdfFilePrintBarItem1";
			// 
			// pdfFindTextBarItem1
			// 
			this.pdfFindTextBarItem1.Id = 4;
			this.pdfFindTextBarItem1.ItemShortcut = new DevExpress.XtraBars.BarShortcut(Keys.Control | Keys.F);
			...
			this.pdfZoomOutBarItem1.SuperTip = superToolTip3;
			// 
			// pdfZoomInBarItem1
			// 
			...
			// pdfRibbonPage1
			// 
			this.pdfRibbonPage1.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] { this.pdfFileRibbonPageGroup1, this.pdfFindRibbonPageGroup1, this.pdfNavigationRibbonPageGroup1, this.pdfZoomRibbonPageGroup1 });
			...
			// 
			this.pdfCommentRibbonPage1.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] { this.pdfTextCommentPageGroup1, this.pdfNoteCommentPageGroup1 });
